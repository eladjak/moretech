...
// Numbers come straight from the EduTech catalog
// (business-docs/טבלת חוויות ותמחור.docx — verified line by line) and are
// cross-checked against the Israeli market (see docs/PRICING-RESEARCH.md):
//  • הרצאה במוסד חינוך/עמותה: כ-2,000–6,500 ₪ בשוק → אנחנו בקצה הנגיש (2,200–3,000).
//  • סדנת AI יום מלא לארגון: ~7,500 ₪ (zebrapps) → בתי ספר משלמים פחות, ולכן
//    טווח הסדנאות שלנו 2,500–8,500 יושב נכון ורווחי.
// המחירים הם "מ-" (base), לפני הוזלות/תוספות. אלעד = עוסק פטור — אין מע"מ.
export type PriceTier = {
  category: string;
  range: string;
  detail: string;
  basis: string; // per-student / per-class / per-school basis
};

export const priceTiers: PriceTier[] = [
  { category: "הרצאות", range: "2,200–3,000 ₪", detail: "שעה–שעתיים, 20–200 משתתפים", basis: "מחיר לאירוע — לכיתה או לשכבה" },
  { category: "סדנאות AI / טכנולוגיה", range: "2,500–8,500 ₪", detail: "מפגש מעשי, 10–30 משתתפים", basis: "מחיר לקבוצה / לכיתה" },
  { category: "קורסים וסמינרים", range: "6,800–12,000 ₪", detail: "תכנית רב-מפגשית עם ליווי", basis: "מחיר לקבוצה לכל התכנית" },
  { category: "ימי שיא והפנינגים", range: "6,500–18,000 ₪", detail: "אירוע בית-ספרי, 50–500 משתתפים", basis: "מחיר ליום — לבית ספר שלם" },
  { category: "פיתוח מקצועי למורים", range: "6,000–25,000 ₪", detail: "השתלמויות 30–60 שעות, מוכר לגמול", basis: "מחיר להשתלמות — לצוות מורים" },
  { category: "קייטנות", range: "15,000–35,000 ₪", detail: "שבוע–שבועיים, כולל מדריכים והסעדה", basis: "מחיר למחזור קייטנה" },
];
...
export const faqs = [
  ...
  {
    q: "כמה זה עולה?",
    a: "המחיר תלוי בסוג הפעילות, מספר המשתתפים, המרחק והפורמט. הרצאות מתחילות מ-2,200 ₪, סדנאות מ-2,500 ₪. רוב הפעילויות מתומחרות לכיתה או לקבוצה (לא לתלמיד), והמחירים סופיים — בלי מע\"מ. יש הנחות להזמנת סדרה, לפריפריה וללקוחות חוזרים. נשמח לבנות הצעה מותאמת בשיחה.",
  },
  {
