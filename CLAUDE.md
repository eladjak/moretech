...
## מסמכים עסקיים
- `business-docs/` - חומרים עסקיים (מועתקים מ-OneDrive/Desktop/EduTech):
  - `EduTech חוויות ותמחור.xlsx` - טבלת חוויות ותמחור
  - `טבלת חוויות ותמחור – EduTech.docx` - מסמך תמחור
  - `לוגו EduTech/` - קבצי לוגו
  - `סדנת כתיבה יצירתית עם ChatGPT/` - חומרי סדנה
  - `הייטקידס/` - חומרי HiTechKids
  - `עבודה על חוויה סדנת AI בסיסית/` - חומרי סדנת AI
